...
import treeCardStyle from "../ui-tree-card/styles/treecard.module.css"
import onboarding2Style from "../ui-onboarding/styles/onboarding2.module.css"
...
export const OnboardingUI = {
  ...
  resetCard: () => {
    ...
    cardButton.classed(`${treeCardStyle['card-button-onboard-disable']}`,true);
    cardButton.classed(`${treeCardStyle['card-button-onboard']}`,false);
    // cardButton.classed(, "");
  ...
  updateCard: (d) => {
    ...
    cardButton.classed(`${treeCardStyle['card-button-onboard-disable']}`,false);
    cardButton.classed(`${treeCardStyle['card-button-onboard']}`,true);
  ...
  showOnboarding2: ()=>{
    ...
    d3.select('#onboarding1').classed(`${onboarding2Style['onboarding1']}`, false)
    d3.select('#onboarding1').classed(`${onboarding2Style['onboarding1-modified']}`, true)
  },
  showOnboarding3: ()=>{
  ...
  dismissTutorial: ()=>{
    ...
    d3.select('#onboardingIntro').style("visibility", "hidden");
    d3.select('#onboardingOutro').style("visibility", "hidden");
    d3.select('#onboarding1').classed(`${onboarding2Style['onboarding1']}`, true)
    d3.select('#onboarding1').classed(`${onboarding2Style['onboarding1-modified']}`, false)
